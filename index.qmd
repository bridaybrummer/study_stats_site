...
::::: {.hero style=" display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 100vh; background-color: #121212; color: #fff; text-align: center; padding: 2rem; "} <!-- Logo --> <img src="logo/StudyStats_Logo Files/CMYK/second_logo_portrait/White/white.png" alt="StudyStats Logo" style="max-width: 300px; margin-bottom: 1.5rem;"/>
