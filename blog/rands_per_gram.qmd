...
# Why This Post?
Ever stood in front of a wall of gels or drink mixes wondering which one actually gives you the best value?  While there are various things you can throw into a product, the total amount of carbs per rand spent can be a good way to find the best value product. This post has a look at the real cost of sports nutrition in South Africa—specifically, how much you’re paying for each gram of carbohydrate in the product. Whether you’re prepping for a big race or just want to get the most bang for your buck, this guide will help you spot the best deals (and the slight rip-offs) on the market.

# How We Did It
We let chatbots do the heavy lifting - scraping products, from various south African websites using single quantities for products, and then double-checked everything by hand. For each product, we grabbed the price, serving size, and carb content straight from the nutrition label and website, then crunched the numbers to get the rands per gram. To keep things fair, we split products into four groups: gels, bars, drink mixes, and everyday foods (because sometimes a banana or slice of bread is all you need). Now, let’s see who’s selling the real fuel, or just selling a marketing strategy. 
