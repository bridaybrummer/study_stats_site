...
description: "Meet Brian Brummer — physiotherapist turned epidemiologist (NICD / Wits) offering biostatistics consulting for MMed, MSc and PhD researchers."
pagetitle: "About StudyStats — Biostatistics Consulting"
format: html
---

<!-- Header Banner -->

![](logo/StudyStats_Logo Files/CMYK/Primary Logo (Landscape)/Grey/StudyStats_Primary Logo_Grey.svg){.img-fluid style="width:100%;"}
...
<img src="images/image_1.webp" alt="Biostatistician Profile" class="rounded-circle" width="150" height="150" loading="lazy" decoding="async" style="width: 150px; height: 150px; object-fit: cover; margin-right: 1rem; border: 3px solid #495057;"/>
